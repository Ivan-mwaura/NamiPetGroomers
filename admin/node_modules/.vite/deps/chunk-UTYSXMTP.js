...
function useRootElementName(parameters) {
  ...
  const [rootElementName, setRootElementName] = React9.useState(rootElementNameProp.toUpperCase());
  if (true) {
    React9.useEffect(() => {
  ...
  const updateRootElementName = React9.useCallback((instance) => {
...
//# sourceMappingURL=chunk-UTYSXMTP.js.map
