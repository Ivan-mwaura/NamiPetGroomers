...
const ApiProvider = ({ children }) => {
	...
	const endpoints = useMemo(
		() => [
			{ key: "users", url: "/api/v1/getLogins" },
			{ key: "admins", url: "/api/v1/getAdminLogins" },
			{ key: "services", url: "/api/v1/getServices" },
			{
				key: "veterinarians",
				url: "/api/v1/getVeterinarians",
			},
			{ key: "contactUsInquiries", url: "/api/v1/getContactUsInquiries" },
			{key: "animalGallery", url: "/api/v1/getAnimalGroomings"},
			{key: "dogproducts", url: "/api/v1/getDogProducts"},
			{key: "catproducts", url: "/api/v1/getCatProducts"},
			{key: "birdproducts", url: "/api/v1/getBirdProducts"},
			{key: "horseproducts", url: "/api/v1/getHorseProducts"},
			{key: "FishAndAcquaticAnimalsProducts", url: "/api/v1/getFishAndAcquaticAnimalsProducts"},
			{ key: "messages", url: "/api/v1/getMessages" },
			{ key: "blogs", url: "/api/v1/getBlogs" },
			{ key: "subscribers", url: "/api/v1/getSubscribers" },
			{key: "pricings", url: "/api/v1/getPricings"},
			{ key: "awards", url: "/api/v1/getServices" },
			{ key: "travels", url: "/api/v1/getServices" },
		],
		[]
	);
